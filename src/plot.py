...
ax1.plot(data1[:, 0], data1[:, 1]+deltaMin, marker="$\u23B5$", color='black',       markersize=12, linestyle='None')
ax1.plot(data1[:, 0], data1[:, 2]+deltaMax, marker="$\u23B4$", color='black', markersize=12, linestyle='None')
ax1.plot(data2[:, 0], data2[:, 1]+deltaMin, marker="$\u23B5$", color='red',         markersize=12, linestyle='None')
ax1.plot(data2[:, 0], data2[:, 2]+deltaMax, marker="$\u23B4$", color='red',   markersize=12, linestyle='None')
ax1.plot(data3[:, 0], data3[:, 1]+deltaMin, marker="$\u23B5$", color='blue',        markersize=12, linestyle='None')
ax1.plot(data3[:, 0], data3[:, 2]+deltaMax, marker="$\u23B4$", color='blue',  markersize=12, linestyle='None')
