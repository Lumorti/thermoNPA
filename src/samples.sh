...
do
    ...
    # Only automatic 100
    ./run -B -N "auto100, 95%" -p 95 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 --objPurity --shots ${shots} --auto 100 | tee -a data/measure.dat
    ./run -B -N "auto100, 99.7%" -p 99.7 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 --objPurity --shots ${shots} --auto 100 | tee -a data/measure.dat

    # SDP plus auto 100
    ./run -B -N "sdp+auto100, 95%" -p 95 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 -A ${A} --objPurity --shots ${shots} --auto 100 | tee -a data/measure.dat
    ./run -B -N "sdp+auto100, 99.7%" -p 99.7 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 -A ${A} --objPurity --shots ${shots} --auto 100 | tee -a data/measure.dat

    # Only automatic 200
    ./run -B -N "auto200, 95%" -p 95 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 --objPurity --shots ${shots} --auto 200 | tee -a data/measure.dat
    ./run -B -N "auto200, 99.7%" -p 99.7 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 --objPurity --shots ${shots} --auto 200 | tee -a data/measure.dat

    # SDP plus auto 200
    ./run -B -N "sdp+auto200, 95%" -p 95 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 -A ${A} --objPurity --shots ${shots} --auto 200 | tee -a data/measure.dat
    ./run -B -N "sdp+auto200, 99.7%" -p 99.7 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 -A ${A} --objPurity --shots ${shots} --auto 200 | tee -a data/measure.dat

    # Only automatic 300
    ./run -B -N "auto300, 95%" -p 95 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 --objPurity --shots ${shots} --auto 300 | tee -a data/measure.dat
    ./run -B -N "auto300, 99.7%" -p 99.7 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 --objPurity --shots ${shots} --auto 300 | tee -a data/measure.dat

    # SDP plus auto 300
    ./run -B -N "sdp+auto300, 95%" -p 95 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 -A ${A} --objPurity --shots ${shots} --auto 300 | tee -a data/measure.dat
    ./run -B -N "sdp+auto300, 99.7%" -p 99.7 -s M --2dtfi ${systemSize} --precomputed ${filenameEnergy} --millis -S 1 -A ${A} --objPurity --shots ${shots} --auto 300 | tee -a data/measure.dat
...
do
    ...
    # SDP plus 1000 automatic
    ./run -B -S 1 -N "sdp+auto1000, 95%" -p 95 -s M --mg ${systemSize} --known -A ${A} -H --shots ${shots} --auto 1000 | tee -a data/measure.dat
    ./run -B -S 1 -N "sdp+auto1000, 99.7%" -p 99.7 -s M --mg ${systemSize} --known -A ${A} -H --shots ${shots} --auto 1000 | tee -a data/measure.dat
